...
// Trending Indian Destinations rail. Server-fetched from Supabase so it
// shows real destinations + self-healing Unsplash images.

import Link from "next/link";
import HorizontalRail from "./HorizontalRail";
import DestinationCard from "@/components/cards/DestinationCard";
import { ArrowRightIcon } from "@/components/ui/Icons";
import { listTrendingDestinations } from "@/lib/queries/destinations";

export default async function TrendingDestinationsSection() {
  const destinations = await listTrendingDestinations(8);
